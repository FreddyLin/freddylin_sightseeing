...
const locations = [
    ...
    // Sehenwürdigkeit #5 Barfüsserkirche
    {
        ...
        longDescription: {
            de: 'Die Barfüsserkirche ist eine der bekanntesten historischen Sehenswürdigkeiten in Basel. Sie wurde im 13. Jahrhundert von den Franziskanermönchen erbaut, die als "Barfüsser" bekannt waren, da sie sandalenlos lebten. Das gotische Bauwerk besticht durch seine schlichte, aber beeindruckende Architektur und dient heute als Heimat des Historischen Museums Basel. In ihrem Inneren findet man eine außergewöhnliche Sammlung, die die reiche Geschichte der Region beleuchtet. Besonders sehenswert sind mittelalterliche Kunstwerke, darunter Skulpturen, Altäre und liturgische Gegenstände. Die Kirche ist zudem ein Ort für kulturelle Veranstaltungen wie Konzerte und Vorträge. Mitten in der Altstadt gelegen, ist die Barfüsserkirche ein Muss für Geschichts- und Kunstliebhaber, die die mittelalterliche Atmosphäre Basels erleben möchten.',
            en: 'The Barfüsser Church is one of the most renowned historical landmarks in Basel. Built in the 13th century by Franciscan monks, known as "barefoot friars" because of their simple lifestyle, this Gothic structure impresses with its modest yet striking architecture. Today, it houses the Historical Museum Basel. Inside, visitors can explore a remarkable collection showcasing the rich history of the region. Highlights include medieval art, such as sculptures, altars, and liturgical items. The church also hosts cultural events, including concerts and lectures. Situated in the heart of the old town, the Barfüsser Church is a must-see for history and art enthusiasts eager to experience Basel’s medieval charm.',
            fr: 'L\'église des Cordeliers, appelée Barfüsserkirche, est l\'un des monuments historiques les plus célèbres de Bâle. Construite au XIIIe siècle par les moines franciscains, surnommés "cordeliers" pour leur mode de vie modeste, cette structure gothique se distingue par son architecture simple mais impressionnante. Elle abrite aujourd\'hui le Musée historique de Bâle. À l’intérieur, on trouve une collection remarquable qui met en lumière l\'histoire riche de la région. Parmi les pièces maîtresses figurent des œuvres d\'art médiévales, telles que des sculptures, des autels et des objets liturgiques. L\'église accueille également des événements culturels, comme des concerts et des conférences. Située au cœur de la vieille ville, la Barfüsserkirche est un lieu incontournable pour les amateurs d\'histoire et d\'art souhaitant plonger dans l’atmosphère médiévale de Bâle.'
        },
        images: [
